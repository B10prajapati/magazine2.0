...
// Blog data
  $get_data = CallAPI('GET',SITE_URL.'api/blog/read?method=byDate&date='.$_GET['date'], false);
...
<h6>FEAtured</h6>
  ...
  <div class="row">
    ...
    <!-- According to date  -->
      <?php array_map('renderRecent', getRandomData($blog_data, 4, false));?>  
  </div>
  ...
  <div class="row">
    ...
    <div class="col-lg-8">
      <!-- Acoording to date -->
      <h6>Recent</h6>
      <?php array_map('renderMostPopular', getRandomData($blog_data, 2, false));?>  
    </div> 
    <!-- Content Side Column -->
    <div class="col-lg-4">
