<?php
  ...
  // Most popular  Data
  $get_data = CallAPI('GET',SITE_URL.'api/blog/read?method=getAllPopularBlogByCategoryWithLimit&cat_id='.$_GET['id'].'&offset=0&no_of_data=4', false);
  $response = json_decode($get_data, true);
  ...
  // Most recent  Data
  $get_data = CallAPI('GET',SITE_URL.'api/blog/read?method=getAllRecentBlogByCategoryWithLimit&cat_id='.$_GET['id'].'&offset=0&no_of_data=6', false);
  $response = json_decode($get_data, true);
  ...
  // Featured BLog Data 
  $get_data = CallAPI('GET',SITE_URL.'api/blog/read?method=getAllFeaturedBlogByCategoryWithLimit&cat_id='.$_GET['id'].'&offset=0&no_of_data=6', false);
  $response = json_decode($get_data, true);
...
<h6>FEAtured</h6>
  ...
  <div class="row">
    ...
    <div class="col-lg-4">
     ...
     <!-- AD -->
     <h6>Advertisement</h6>
      <?php array_map('renderAd', getRandomData($adv_data, 1));?>  
     <!-- Categories -->
     <h6>Category</h6>
